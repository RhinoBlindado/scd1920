...
{
  int id_ten_izq = id + num_filosofos,
      id_ten_der = ((id+num_filosofos-1)%num_filosofos)+num_filosofos;
      cout<<"calculo: filo"<<id<<" id_der "<<id_ten_der<<" id-1 "<<(id-1)%num_filosofos <<endl;
      int peticion;
